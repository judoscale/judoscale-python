# FastAPI Dramatiq Sample App

This is a minimal FastAPI and Dramatiq app for testing the judoscale package.
...
- the sample app for testing Dramatiq with FastAPI.
